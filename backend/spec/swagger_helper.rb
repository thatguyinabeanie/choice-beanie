...
TOURNAMENT_REQUEST = {
  ...
  required: %w[name game_id format_id autostart player_cap registration_start_at registration_end_at late_registration late_check_in check_in_start_at open_team_sheets teamlists_required]
}
