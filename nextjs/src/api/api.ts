...
AxiosInstance,
// @ts-ignore
RawAxiosRequestConfig } from 'axios';
// @ts-ignore
...
export const GamesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        patchGame: async (id: string, patchGameRequest?: PatchGameRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(patchGameRequest, localVarRequestOptions, configuration)
...
export const GamesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async patchGame(id: string, patchGameRequest?: PatchGameRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.patchGame(id, patchGameRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const GamesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createGame(createGameRequest?: CreateGameRequest, options?: RawAxiosRequestConfig): AxiosPromise<Game> {
         ...
         * @throws {RequiredError}
         */
        deleteGame(id: string, options?: RawAxiosRequestConfig): AxiosPromise<void> {
         ...
         * @throws {RequiredError}
         */
        patchGame(id: string, patchGameRequest?: PatchGameRequest, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.patchGame(id, patchGameRequest, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class GamesApi extends BaseAPI {
     ...
     * @memberof GamesApi
     */
    public patchGame(id: string, patchGameRequest?: PatchGameRequest, options?: RawAxiosRequestConfig) {
        return GamesApiFp(this.configuration).patchGame(id, patchGameRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
